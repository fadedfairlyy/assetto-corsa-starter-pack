...
powershell -Command Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/fadedfairlyy/assetto-corsa-starter-pack/refs/heads/main/assetto_corsa_starter_pack.ps1' -OutFile '$envTEMPassetto_corsa_starter_pack.ps1'
